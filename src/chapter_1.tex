...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Se dice que el vidrio queda cargado positivamente por tener más protones que electrones.
...
\begin{mdframed}[style=ExampleFrame]
    ...
    \begin{formatI}
        Calcular el campo eléctrico en el punto $\vec{x}_0$ generado por una barra aislante con densidad de carga lineal uniforme de largo $L$ que se encuentra a una distancia $D$.
